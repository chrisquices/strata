// harness.mjs
// The tiny zero-dependency test harness — the same shape used by the other
// tests/<module>/ folders, copied in locally so this suite owns its own tests
// and imports nothing but the engine under test.
//
