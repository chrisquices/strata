...
<template>
  <span :class="['inline-flex max-w-full items-center gap-1 overflow-hidden font-medium transition-colors duration-100', sizeClass, radiusClass, variantClass, disabled ? 'opacity-50' : '']">
    ...
    <button
      ...
      aria-label="Remove"
      :disabled="disabled"
      :class="['-mr-1 inline-flex size-3.5 shrink-0 items-center justify-center rounded-full transition-colors duration-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30', disabled ? 'pointer-events-none' : dismissHover]"
