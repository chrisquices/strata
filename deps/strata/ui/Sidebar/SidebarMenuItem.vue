      ...
      <CollapsibleTrigger as-child>
        ...
        >
          ...
          <span class="overflow-hidden max-w-[20px] flex items-center transition-[max-width,opacity] duration-300 group-data-[collapsed]/sidebar:max-w-0 group-data-[collapsed]/sidebar:opacity-0">
            <ChevronRight class="size-icon-small shrink-0 text-faint transition-transform duration-200 group-data-[state=open]/collapsible:rotate-90" aria-hidden="true" />
          </span>
...
.strata-sidebar-menu-item {
  ...
  transition-duration: var(--duration-100, 150ms), var(--duration-100, 150ms), 300ms, 300ms, 300ms;
}
