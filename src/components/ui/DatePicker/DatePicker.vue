...
watch(model, function (newValue) {
  const date = dateFromIso(newValue);
  ...
  >
    ...
    >
      ...
      <DatePickerTrigger
          ...
          class="grid size-6 shrink-0 place-items-center rounded text-muted transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/40"
      >
