...
<template>
  <TogglePrimitive
    ...
    :disabled="disabled"
    :class="[
      'inline-flex items-center justify-center gap-1.5 rounded-medium transition-colors duration-fast focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30 select-none',
      sizeClass[size],
