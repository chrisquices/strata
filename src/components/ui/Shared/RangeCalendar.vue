...
import {dateFromIso, todayDate, rangeFromIso, isoFromRange} from './utils';
import type {IsoRange, DateRange} from './utils';
        ...
        <RangeCalendarGridHead>
          <RangeCalendarGridRow class="flex">
            <RangeCalendarHeadCell v-for="day in weekDays" :key="day"
                                   class="grid size-9 place-items-center text-xs font-normal text-faint">{{ day }}
