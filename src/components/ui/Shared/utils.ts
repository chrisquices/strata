// Shared utilities for the Strata UI kit.
// Uses only built-in browser APIs — no external dependencies.
...
// Lightweight value objects for reka-ui's date components. Components expose
// ISO strings as v-model and convert to/from these types internally.
