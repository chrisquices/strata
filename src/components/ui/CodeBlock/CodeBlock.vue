...
<template>
  <div class="overflow-hidden rounded-large border border-border bg-surface font-mono text-xs">
    <div class="flex h-control items-center justify-between border-b border-border px-3">
      ...
      <button
        type="button"
        class="-mr-1.5 flex h-control-small items-center gap-1.5 rounded-medium px-2 text-muted transition-colors duration-fast hover:bg-border hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30"
        @click="copyCode"
      >
