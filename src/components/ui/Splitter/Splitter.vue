...
defineProps({
  direction: { type: String as PropType<'horizontal' | 'vertical'>, default: 'horizontal', validator: (value: string) => ['horizontal', 'vertical'].includes(value) },
  ...
  storage: { type: Object as PropType<{ getItem: (name: string) => string | null; setItem: (name: string, value: string) => void }>, default: undefined },
});
