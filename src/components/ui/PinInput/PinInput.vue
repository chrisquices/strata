...
const cellClass =
  'flex h-control w-10 items-center justify-center rounded-medium border border-border bg-input text-center text-sm text-foreground transition-colors duration-fast focus:border-foreground focus:outline-none focus:ring-2 focus:ring-foreground/30';
</script>
