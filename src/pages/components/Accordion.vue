...
const faq = [
  { value: 'shipping', q: 'How long does shipping take?', a: 'Orders leave the warehouse within 24 hours and arrive in 3–5 business days for domestic addresses.' },
  { value: 'returns', q: 'What is the return policy?', a: 'Anything can come back within 30 days, unworn and in original packaging, for a full refund.' },
  { value: 'warranty', q: 'Is there a warranty?', a: 'Every product carries a two-year warranty covering manufacturing defects.' },
];
...
<template>
  ...
  <div class="flex flex-col gap-14">
    ...
    <ComponentItemSection>
      ...
      <ComponentItemSectionDescription>
        Several items open at once. Model is an array — currently: {{ multiOpen.length ? multiOpen.join(', ') : 'none' }}
      </ComponentItemSectionDescription>
      <ComponentItemSectionExample>
    ...
    <ComponentItemSection>
      ...
      <ComponentItemSectionDescription>
        unmount-on-hide off at the root keeps closed content rendered (hidden), while the last item overrides back to unmounting.
      </ComponentItemSectionDescription>
      <ComponentItemSectionExample>
